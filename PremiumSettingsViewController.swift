//
//  PremiumSettingsViewController.swift
//  Signup
//
...
//import Firebase
//import FirebaseAuth
class PremiumSettingsViewController: UIViewController,CLLocationManagerDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
